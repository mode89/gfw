#ifndef __GFW_PIPELINE_FX_COMMON_EFFECT_BUILDER_EXCEPTION_H__
#define __GFW_PIPELINE_FX_COMMON_EFFECT_BUILDER_EXCEPTION_H__
...
#endif // __GFW_PIPELINE_FX_COMMON_EFFECT_BUILDER_EXCEPTION_H__
