...
namespace GFW {
    ...
    public:
        bool Initialize()
        {
            ...
            {
                CMN_ERR( "Failed to register window class" );
                return false;
            }
        ...
        ~WindowClass()
        {
            ...
            {
                CMN_ERR( "Failed to unregister the window class" );
                return;
            }
        }
        ...
        static WindowClass * GetInstance()
        {
            if (mInstance == NULL)
            {
                ...
                {
                    CMN_ERR( "Failed to initialize the window class" );
                    delete mInstance;
                    mInstance = NULL;
                    return NULL;
                }
    ...
    WindowHandle CreateDefaultWindow(const WindowDesc & desc)
    {
        ...
        if (desc.isFullscreen)
        {
            ...
            {
                CMN_ERR( "Failed to enter fullscreen mode" );
                return NULL;
            }
        }
        ...
        if (handle == NULL)
        {
            CMN_ERR( "Failed to create a window" );
            return NULL;
        }
