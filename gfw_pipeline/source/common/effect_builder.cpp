...
namespace GFW { namespace Pipeline {
    ...
    EffectBinaryRef EffectBuilder::Build(const char * fileName)
    {
        ...
        // API/Object, which you can customize and override methods of as you wish. a Token stream is
        ...
        //
        FXParser_translation_unit_return  langAST;


        // The tree nodes are managed by a tree adaptor, which doles
        // out the nodes upon request. You can make your own tree types and adapters
        ...
        */
        ...
        //
        lxr        = FXLexerNew(input);      // CLexerNew is generated by ANTLR
        ...
        //
        psr        = FXParserNew(tstream);  // CParserNew is generated by ANTLR3
        ...
        //
        langAST = psr->translation_unit(psr);
